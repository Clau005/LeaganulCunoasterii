...
export const GoogleSignIn = () => {
    return (
        <div className="flex flex-row items-center justify-center space-x-5 px-12 py-2 shadow-md bg-white">
        <svg className="w-8 h-8" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
          <path
            fill="#4285F4"
            fillRule="evenodd"
        ...
        <span className="text-xl text-black">Sign in with Google</span>
      </div>
    )
}