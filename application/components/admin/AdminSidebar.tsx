            ...
            <div className="left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 text-xl " aria-label="Sidebar">
                <div className=" px-3 py-4  space-y-4">
                    <ul className="space-y-2 font-medium mt-[32px]">
                        <li className="">
                            <a href="#" className="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-700 dark:hover:bg-gray-200">
                    ...
                    <button className="flex items-center bg-[white] p-2 m-2 rounded-lg text-[grey] font-bold" onClick={handleSignOut}>
                        Sign out!
                    </button>
                </div>
            </div>          
